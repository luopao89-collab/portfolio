            ...
            <div className="space-y-12">
              {project.details?.results ? (
                project.details.results.map((img, idx) => (
                  <div 
                    key={idx} 
                    className="rounded-[24px] overflow-hidden bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex justify-center transition-all duration-500 relative cursor-pointer"
